...
| CUJ-D | Read and shop in English                     | Switch FR → EN from any page → read a fragrance in English (notes, description, `€` price) → add to bag → bag and cart in English → switch back to FR on the same page                               | `e2e/i18n.spec.ts`                                     | `i18n-*`                       |
